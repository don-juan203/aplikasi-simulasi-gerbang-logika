<script lang="ts">
    ...
    import img from '$lib/assets/not.png';
  ...
  <div class="custom">
    <!-- <div class="label" style="margin-top: auto; margin-bottom: auto;">NOT</div> -->
    <img class="node-img" src="{img}" alt="NOT">
    <Handle
      type="target"
